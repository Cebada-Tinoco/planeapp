  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#f9f9ff" }}>
      <div className="p-4 safe-top">
        <Link href="/" className="inline-flex items-center gap-1.5 text-gray-500 font-medium">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 pb-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-[#111c2d]">Bienvenido</h1>
          <p className="text-gray-500 mt-1 text-sm font-medium">Inicia sesión para ver y unirte a planes</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6 font-medium">
          ¿No tienes cuenta?{" "}
          <Link href="/auth/register" className="font-bold" style={{ color: "#ff6b52" }}>
            Regístrate
          </Link>
        </p>
      </div>
